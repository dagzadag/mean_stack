...
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../services/auth.service */ "./src/services/auth.service.ts");
...
const appRoutes = [
    ...
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_12__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] }
];
...
let LoginComponent = class LoginComponent {
    constructor(validateService, falshMessages, authService, router) {
    ...
    onLoginSubmit() {
        ...
        if (!this.validateService.validateLogin(user)) {
            return this.falshMessages.show("Please fill all info", { cssClass: 'alert-danger', timeout: 3000 });
        }
        //check if email or username
        this.authService.authenticatUser(user).subscribe(data => {
            if (data.success) {
                this.falshMessages.show(data.msg, { cssClass: 'alert-success', timeout: 3000 });
                this.authService.storeUserData(data.token, data.user);
                this.router.navigate(['/dashboard']);
            }
            else {
                this.falshMessages.show(data.msg, { cssClass: 'alert-danger', timeout: 3000 });
...
let RegisterComponent = class RegisterComponent {
    ...
    onRegisterSubmit() {
        ...
        this.authService.registerUser(user).subscribe(data => {
            if (data.success) {
                this.falshMessages.show("You have successfully signedup you can log in", { cssClass: 'alert-success', timeout: 3000 });
                this.router.navigate(['/login']);
            }
            else {
...
let AuthService = class AuthService {
    constructor(http, jwtH) {
        this.http = http;
        this.jwtH = jwtH;
    }
    registerUser(user) {
        let httpOptions = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' }) };
        return this.http.post('http://164.68.110.12:3000/users/register', user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    authenticatUser(user) {
        let httpOptions = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' }) };
        return this.http.post('http://164.68.110.12:3000/users/login', user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    getProfile() {
        this.loadToken();
        ...
        return this.http.get('http://164.68.110.12:3000/users/profile', { headers: headers, responseType: 'json' });
    }
    loadToken() {
...
module.exports = __webpack_require__(/*! /root/myProjects/mean_satck/angular-src/src/main.ts */"./src/main.ts");
